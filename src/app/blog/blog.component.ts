...
import type { Posts } from '../posts.interface.js';
...
export class BlogComponent {
  ...
  public viewMode = signal<ViewMode>('list'); // Default matching image
  public currentPage = signal<number>(1);
  public itemsPerPage = signal<number>(3);
  public searchQuery = signal<string>('');
  public selectedCategory = signal<string>('جميع المقالات');

  // Filtered Articles Computation
  public filteredArticles = computed(() => {
    return this.Article.filter((post: Posts) => {
  ...
  // Paginated Articles Computation
  public paginatedArticles = computed(() => {
